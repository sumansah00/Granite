...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_show_preference_for_a_valid_user
    get api_v1_preference_path, headers: @headers
    assert_response :ok
  ...
  def test_update_success
    ...
    put api_v1_preference_path, params: preference_params, headers: @headers
    @preference.reload
    assert_response :ok
  ...
  def test_update_success_mail
    ...
    patch mail_api_v1_preference_path, params: preference_params, headers: @headers
    @preference.reload
    assert_response :ok
    refute @preference.should_receive_email
  end
